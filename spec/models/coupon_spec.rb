...
RSpec.describe Coupon, type: :model do
  ...
  it "has a unique ID that is valid" do
    ...
    coupon_1 = merchant_1.coupons.create(name: "15% off", uniq_code: "loll", amt_off: 15, dollar_or_percent: 1, status: 1)
    coupon_2 = merchant_1.coupons.create(name: "5_dollars_off", uniq_code: "loll", amt_off: 5, dollar_or_percent: 0, status: 1)
