...
describe "Coupons" do
  describe "index page" do
    ...
    coupon_1 = merchant_1.coupons.create(name: "15% off", uniq_code: "15%OFF", amt_off: 15, dollar_or_percent: "%")
    coupon_2 = merchant_1.coupons.create(name: "5_dollars_off", uniq_code: "$5OFF", amt_off: 5, dollar_or_percent: "$")
    coupon_3 = merchant_1.coupons.create(name: "10_dollars_off", uniq_code: "$10OFF", amt_off: 10, dollar_or_percent: "$")
