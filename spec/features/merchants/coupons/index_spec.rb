...
describe "Coupons" do
  describe "index page" do
    ...
    coupon_5 = merchant_1.coupons.create!(name: "1_dollars_off", uniq_code: "rfv", amt_off: 1, dollar_or_percent: 0, status: 1)
    # coupon_6 = merchant_1.coupons.create!(name: "6_dollars_off", uniq_code: "tgb", amt_off: 6, dollar_or_percent: 0, status: 1)
  ...
  it "separates active and inactive coupons on the index page" do
    ...
    coupon_2 = merchant_1.coupons.create!(name: "5_dollars_off", uniq_code: "ikm", amt_off: 5, dollar_or_percent: 0, status: 1)
    coupon_3 = merchant_1.coupons.create!(name: "10_dollars_off", uniq_code: "qaz", amt_off: 10, dollar_or_percent: 0, status: 1)
    coupon_4 = merchant_1.coupons.create!(name: "4_dollars_off", uniq_code: "wsx", amt_off: 4, dollar_or_percent: 0, status: 0)
    coupon_5 = merchant_1.coupons.create!(name: "1_dollars_off", uniq_code: "rfv", amt_off: 1, dollar_or_percent: 0, status: 0)
